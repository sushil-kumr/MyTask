...
class MenuFragment : BaseMvRxFragment() {
...
//        Log.d("Sam",position.toString());
    ...
    override fun onCreateView(
        ...
        if (activity.getMenuData(position) != null)
            menuList = activity.getMenuData(position)!!


        var mList: RecyclerView = view?.findViewById(R.id.menu_list)
